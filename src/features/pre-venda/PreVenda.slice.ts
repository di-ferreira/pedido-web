...
export const preVendaSlice = createSlice({
  ...
  extraReducers(builder) {
    ...
    builder
      ...
      .addCase(GetPreVenda.fulfilled, (state, action: PayloadAction<iMovimento | undefined>) => {
        state.isLoading = false;
        state.errorMessage = '';
        if (action.payload) {
    ...
    builder
      ...
      .addCase(SavePreVenda.fulfilled, (state, action: PayloadAction<iMovimento | undefined>) => {
        state.isLoading = false;
        state.errorMessage = '';
